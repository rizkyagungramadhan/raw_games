...
GameDetailResponse mockGameDetailResponse({bool withGenre = true}) {
...
GameResponse mockGameResponse({
  bool withMetacriticScore = true,
  ...
  return GameResponse(
    ...
    withPlatform
        ? [
            PlatformWrapper(PlatformResponse(1, "PC", "pc")),
            PlatformWrapper(
                PlatformResponse(2, "PlayStation 3", "playstation3")),
            PlatformWrapper(
                PlatformResponse(3, "PlayStation 4", "playstation4")),
            PlatformWrapper(PlatformResponse(4, "Xbox 360", "xbox-360")),
            PlatformWrapper(PlatformResponse(5, "Xbox One", "xbox-one")),
            PlatformWrapper(
                PlatformResponse(6, "PlayStation 5", "playstation5")),
            PlatformWrapper(
                PlatformResponse(7, "Xbox Series S/X", "xbox-series-s-x")),
          ]
        : [],
    withMetacriticScore ? 92 : null,
    "https://media.rawg.io/media/games/456/456dea5e1c7e3cd07060c14e96612001.jpg",
    4.47,
  );
}
